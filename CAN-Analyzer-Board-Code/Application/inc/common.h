...
union {
	...
	struct {
		/*Buffer[0]*/
		COMMON_u8 Filter_Command;
		COMMON_u8 Filter_Reserved_0[3];

		/*Buffer[1]*/
		COMMON_u32  Filter_Type:2;
		COMMON_u32  Filter_Index:6;
		COMMON_u32  Filter_Reserved_1:23;
		COMMON_u32  Filter_FrameType:1;
		/*Buffer[2]*/
		COMMON_u32  Filter_ID;

		/*Buffer[3]*/
		COMMON_u32  Filter_MaskOrID;
	};
	/*UI_Send_Baudrate_Configurations*/
	struct {
		/*Buffer[0]*/
		COMMON_u8 Baudrate_Command;
		COMMON_u8 Baudrate_Reserved_0[3];
		/*Buffer[1]*/
		COMMON_u32 BaudRate_Prescaller;
		/*Buffer[2]*/
		COMMON_u8  BaudRate_TimeQuanta_1;
		COMMON_u8  BaudRate_TimeQuanta_2;
		COMMON_u8  BaudRate_ReSynchronizationJump;
		/*Buffer[3]*/
